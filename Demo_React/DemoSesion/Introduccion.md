...
Cliente --> En cadanueva petición envia la cookie con el ID de sesión
...
* indexDB --> Base de datos del navgador web
* cookie --> Es configurable y de mayor mivel de seguridad con httpOnly 